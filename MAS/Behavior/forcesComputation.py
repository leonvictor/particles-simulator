...
class ForcesComputation :
    ...
    def vanDerWaals(agent, perceptions):
        ...
        for p in perceptions:
            ...
            e_debye = (((agent.dipole_moment ** 2) * p.polarizability) + ((p.dipole_moment ** 2)*agent.polarizability))/(4 * const.pi * const.epsilon_0 * agent.environment.relative_permittivity)
            ...
            e_london = (
                           ...
                           4 * const.pi * const.epsilon_0 * agent.environment.relative_permittivity)
